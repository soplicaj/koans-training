...
C:\jdk-11.0.2\bin\javac -version
if ERRORLEVEL 3 goto no_javac
C:\jdk-11.0.2\bin\java -version
if ERRORLEVEL 1 goto no_java
cls
C:\jdk-11.0.2\bin\java -Dapplication.basedir="%~dp0"" -classpath %CLASSPATH% com.sandwich.koan.runner.AppLauncher %1 %2 %3 %4 %5 %6 %7 %8 %9
